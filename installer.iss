; Inno Setup script for Shani Pharmacy Management System (SPMS).
...
#define MyAppName "Shani Pharmacy Management System (SPMS)"
#define MyAppVersion "1.0"
#define MyAppPublisher "Shani Pharmacy Management System (SPMS)"
